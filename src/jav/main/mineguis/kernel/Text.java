...
public class Text extends Unit {
    ...
    static public HashMap<String, Text> getTextTab() { return tab; }

    static public Text getText(TextComponent objText) { return getText(objText.getText()); }
    static public Text getText(String strSign) {
